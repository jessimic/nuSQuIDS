...
//	nuSQUIDSNSI::nuSQUIDSNSI(unsigned int numneu, NeutrinoType NT):
//		nuSQUIDS(numneu,NT),
//		hiBuffer(new double[nsun*nsun]),epsilon_mutau(0),epsilon_mumu(0),epsilon_tautau(0),epsilon_emu(0),epsilon_ee(0),epsilon_etau(0)
//	{
//		assert(numneu == 3);
...
//		Set_epsilons();
//	}
//	nuSQUIDSNSI::nuSQUIDSNSI(std::string hdf5_filename, std::string grp,
...
//	}
//	nuSQUIDSNSI::nuSQUIDSNSI(nuSQUIDSNSI&& other):
//		nuSQUIDS::nuSQUIDS(std::move(other)),
//		hiBuffer(std::move(other.hiBuffer)),
//		epsilon_ee(other.epsilon_ee),
//		epsilon_emu(other.epsilon_emu),
//		epsilon_etau(other.epsilon_etau),
//		epsilon_mumu(other.epsilon_mumu),
//		epsilon_mutau(other.epsilon_mutau),
//		epsilon_tautau(other.epsilon_tautau)
//	{
//		Set_epsilons();
//	}
